...
@useResult
$Res call({
 bool isInit, bool backBlock, PageLabel pageLabel, List<Package> packages, int sortNum, Size viewSize, DelayMap delayMap, List<Group> groups, int checkIpNum, Brightness? brightness, int? runTime, List<ExternalProvider> providers, String? localIp, FixedList<Connection> requests, int version, FixedList<Log> logs, FixedList<Traffic> traffics, Traffic totalTraffic, String proxiesQuery, bool realTunEnable
});
...
as Traffic,proxiesQuery: null == proxiesQuery ? _self.proxiesQuery : proxiesQuery // ignore: cast_nullable_to_non_nullable
as String,realTunEnable: null == realTunEnable ? _self.realTunEnable : realTunEnable // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _AppState implements AppState {
  const _AppState({this.isInit = false, this.backBlock = false, this.pageLabel = PageLabel.xboard, final  List<Package> packages = const [], this.sortNum = 0, required this.viewSize, final  DelayMap delayMap = const {}, final  List<Group> groups = const [], this.checkIpNum = 0, this.brightness, this.runTime, final  List<ExternalProvider> providers = const [], this.localIp, required this.requests, required this.version, required this.logs, required this.traffics, required this.totalTraffic, this.proxiesQuery = "", this.realTunEnable = false}): _packages = packages,_delayMap = delayMap,_groups = groups,_providers = providers;
...
@override@JsonKey() final  String proxiesQuery;
...
@override
int get hashCode => Object.hashAll([runtimeType,isInit,backBlock,pageLabel,const DeepCollectionEquality().hash(_packages),sortNum,viewSize,const DeepCollectionEquality().hash(_delayMap),const DeepCollectionEquality().hash(_groups),checkIpNum,brightness,runTime,const DeepCollectionEquality().hash(_providers),localIp,requests,version,logs,traffics,totalTraffic,proxiesQuery,realTunEnable]);
