...
mixin _$NetworkDetectionState {
 ...
 bool get isLoading; bool get isTesting; IpInfo? get ipInfo;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkDetectionState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isTesting, isTesting) || other.isTesting == isTesting)&&(identical(other.ipInfo, ipInfo) || other.ipInfo == ipInfo));
}
...
@useResult
$Res call({
 bool isLoading, bool isTesting, IpInfo? ipInfo
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool isTesting,  IpInfo? ipInfo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NetworkDetectionState() when $default != null:
return $default(_that.isLoading,_that.isTesting,_that.ipInfo);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool isTesting,  IpInfo? ipInfo)  $default,) {final _that = this;
switch (_that) {
case _NetworkDetectionState():
return $default(_that.isLoading,_that.isTesting,_that.ipInfo);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool isTesting,  IpInfo? ipInfo)?  $default,) {final _that = this;
switch (_that) {
case _NetworkDetectionState() when $default != null:
return $default(_that.isLoading,_that.isTesting,_that.ipInfo);case _:
  return null;
...
class _NetworkDetectionState implements NetworkDetectionState {
  const _NetworkDetectionState({required this.isLoading, required this.isTesting, required this.ipInfo});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NetworkDetectionState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isTesting, isTesting) || other.isTesting == isTesting)&&(identical(other.ipInfo, ipInfo) || other.ipInfo == ipInfo));
}
...
/// Create a copy of NetworkDetectionState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? isTesting = null,Object? ipInfo = freezed,}) {
...
mixin _$ProxiesListSelectorState {
 ...
 List<String> get groupNames; Set<String> get currentUnfoldSet; ProxiesSortType get proxiesSortType; ProxyCardType get proxyCardType; num get sortNum; int get columns; String get query;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(groupNames),const DeepCollectionEquality().hash(currentUnfoldSet),proxiesSortType,proxyCardType,sortNum,columns,query);
...
@useResult
$Res call({
 List<String> groupNames, Set<String> currentUnfoldSet, ProxiesSortType proxiesSortType, ProxyCardType proxyCardType, num sortNum, int columns, String query
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<String> groupNames,  Set<String> currentUnfoldSet,  ProxiesSortType proxiesSortType,  ProxyCardType proxyCardType,  num sortNum,  int columns,  String query)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProxiesListSelectorState() when $default != null:
return $default(_that.groupNames,_that.currentUnfoldSet,_that.proxiesSortType,_that.proxyCardType,_that.sortNum,_that.columns,_that.query);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<String> groupNames,  Set<String> currentUnfoldSet,  ProxiesSortType proxiesSortType,  ProxyCardType proxyCardType,  num sortNum,  int columns,  String query)  $default,) {final _that = this;
switch (_that) {
case _ProxiesListSelectorState():
return $default(_that.groupNames,_that.currentUnfoldSet,_that.proxiesSortType,_that.proxyCardType,_that.sortNum,_that.columns,_that.query);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<String> groupNames,  Set<String> currentUnfoldSet,  ProxiesSortType proxiesSortType,  ProxyCardType proxyCardType,  num sortNum,  int columns,  String query)?  $default,) {final _that = this;
switch (_that) {
case _ProxiesListSelectorState() when $default != null:
return $default(_that.groupNames,_that.currentUnfoldSet,_that.proxiesSortType,_that.proxyCardType,_that.sortNum,_that.columns,_that.query);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_groupNames),const DeepCollectionEquality().hash(_currentUnfoldSet),proxiesSortType,proxyCardType,sortNum,columns,query);
...
/// Create a copy of ProxiesListSelectorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupNames = null,Object? currentUnfoldSet = null,Object? proxiesSortType = null,Object? proxyCardType = null,Object? sortNum = null,Object? columns = null,Object? query = null,}) {
