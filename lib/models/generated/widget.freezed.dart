...
mixin _$CommonMessage {
 ...
 String get id; String get text; Duration get duration; VoidCallback? get onTap;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommonMessage&&(identical(other.id, id) || other.id == id)&&(identical(other.text, text) || other.text == text)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.onTap, onTap) || other.onTap == onTap));
}
...
@useResult
$Res call({
 String id, String text, Duration duration, VoidCallback? onTap
});
...
/// Create a copy of CommonMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? text = null,Object? duration = null,Object? onTap = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,text: null == text ? _self.text : text // ignore: cast_nullable_to_non_nullable
as String,duration: null == duration ? _self.duration : duration // ignore: cast_nullable_to_non_nullable
as Duration,onTap: freezed == onTap ? _self.onTap : onTap // ignore: cast_nullable_to_non_nullable
as VoidCallback?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String text,  Duration duration,  VoidCallback? onTap)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommonMessage() when $default != null:
return $default(_that.id,_that.text,_that.duration,_that.onTap);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String text,  Duration duration,  VoidCallback? onTap)  $default,) {final _that = this;
switch (_that) {
case _CommonMessage():
return $default(_that.id,_that.text,_that.duration,_that.onTap);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String text,  Duration duration,  VoidCallback? onTap)?  $default,) {final _that = this;
switch (_that) {
case _CommonMessage() when $default != null:
return $default(_that.id,_that.text,_that.duration,_that.onTap);case _:
  return null;
...
class _CommonMessage implements CommonMessage {
  const _CommonMessage({required this.id, required this.text, this.duration = const Duration(seconds: 3), this.onTap});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommonMessage&&(identical(other.id, id) || other.id == id)&&(identical(other.text, text) || other.text == text)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.onTap, onTap) || other.onTap == onTap));
}
...
/// Create a copy of CommonMessage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? text = null,Object? duration = null,Object? onTap = freezed,}) {
...
mixin _$AppBarState {
 ...
 List<Widget> get actions; Widget? get leading; AppBarSearchState? get searchState; AppBarEditState? get editState;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppBarState&&const DeepCollectionEquality().equals(other.actions, actions)&&(identical(other.leading, leading) || other.leading == leading)&&(identical(other.searchState, searchState) || other.searchState == searchState)&&(identical(other.editState, editState) || other.editState == editState));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(actions),leading,searchState,editState);
...
@useResult
$Res call({
 List<Widget> actions, Widget? leading, AppBarSearchState? searchState, AppBarEditState? editState
});
...
/// Create a copy of AppBarState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? actions = null,Object? leading = freezed,Object? searchState = freezed,Object? editState = freezed,}) {
  return _then(_self.copyWith(
actions: null == actions ? _self.actions : actions // ignore: cast_nullable_to_non_nullable
as List<Widget>,leading: freezed == leading ? _self.leading : leading // ignore: cast_nullable_to_non_nullable
as Widget?,searchState: freezed == searchState ? _self.searchState : searchState // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Widget> actions,  Widget? leading,  AppBarSearchState? searchState,  AppBarEditState? editState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppBarState() when $default != null:
return $default(_that.actions,_that.leading,_that.searchState,_that.editState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Widget> actions,  Widget? leading,  AppBarSearchState? searchState,  AppBarEditState? editState)  $default,) {final _that = this;
switch (_that) {
case _AppBarState():
return $default(_that.actions,_that.leading,_that.searchState,_that.editState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Widget> actions,  Widget? leading,  AppBarSearchState? searchState,  AppBarEditState? editState)?  $default,) {final _that = this;
switch (_that) {
case _AppBarState() when $default != null:
return $default(_that.actions,_that.leading,_that.searchState,_that.editState);case _:
  return null;
...
class _AppBarState implements AppBarState {
  const _AppBarState({final  List<Widget> actions = const [], this.leading, this.searchState, this.editState}): _actions = actions;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppBarState&&const DeepCollectionEquality().equals(other._actions, _actions)&&(identical(other.leading, leading) || other.leading == leading)&&(identical(other.searchState, searchState) || other.searchState == searchState)&&(identical(other.editState, editState) || other.editState == editState));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_actions),leading,searchState,editState);
...
/// Create a copy of AppBarState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? actions = null,Object? leading = freezed,Object? searchState = freezed,Object? editState = freezed,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppBarSearchState&&(identical(other.onSearch, onSearch) || other.onSearch == onSearch)&&(identical(other.isSearch, isSearch) || other.isSearch == isSearch));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppBarSearchState&&(identical(other.onSearch, onSearch) || other.onSearch == onSearch)&&(identical(other.isSearch, isSearch) || other.isSearch == isSearch));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppBarEditState&&const DeepCollectionEquality().equals(other.editCount, editCount)&&(identical(other.isEdit, isEdit) || other.isEdit == isEdit)&&(identical(other.onExit, onExit) || other.onExit == onExit));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(editCount),isEdit,onExit);
...
class _AppBarEditState implements AppBarEditState {
  const _AppBarEditState({this.editCount = 0, this.isEdit = false, required this.onExit});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppBarEditState&&const DeepCollectionEquality().equals(other.editCount, editCount)&&(identical(other.isEdit, isEdit) || other.isEdit == isEdit)&&(identical(other.onExit, onExit) || other.onExit == onExit));
}
...
/// Create a copy of AppBarEditState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? editCount = freezed,Object? isEdit = null,Object? onExit = null,}) {
