...
class _InvitePageState extends ConsumerState<InvitePage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final isWyx = await ref.read(isWyxV2BoardBackendProvider.future);
      if (!isWyx &&
          (!inviteState.hasInviteData ||
              inviteState.inviteData!.codes.isEmpty)) {
